...
export default function Banner() {
  return (
    <div className="flex h-56 w-full flex-col items-center justify-center rounded-lg border bg-blue-100 px-8 text-center md:h-48 md:flex-row md:px-0 md:text-left">
      <Image
        src="/hearts.png"
        width={600}
        height={600}
